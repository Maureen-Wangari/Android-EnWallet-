...
data class WalletAdapter(var walletList: List<Wallet>):
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): WalletViewHolder {
        val itemView = LayoutInflater.from(parent.context).inflate(R.layout.expense_layout_item, parent, false)
    ...
    override fun onBindViewHolder(holder: WalletViewHolder, position: Int) {
        ...
        holder.tvCategory2.text = contact.category2
        holder.tvAmount2.text = contact.amount2
        holder.tvDate2.text = contact.date2
    }
